...
export const GREYHAWK_REGIONAL_TABLES = {
  ...
  "bandit_kingdoms": [
    ...
    { "min": 13, "max": 13, "encounter": "Goblin" },
  ...
  [
    ...
    { "min": 4, "max": 5, "encounter": "Giant" },
    { "min": 6, "max": 6, "encounter": "Gnoll" },
    { "min": 7, "max": 15, "encounter": "Hobgoblin", "note": "25% are soldiery" },
    { "min": 16, "max": 20, "encounter": "Hobgoblin and Norker", "note": "20–50 Hobgoblin and Norker" },
    { "min": 21, "max": 22, "encounter": "Humanoid" },
    { "min": 23, "max": 25, "encounter": "Kobolds" },
    { "min": 26, "max": 30, "encounter": "Men, Nomads" },
    { "min": 31, "max": 34, "encounter": "Norker" },
    { "min": 35, "max": 37, "encounter": "Ogre" },
    { "min": 38, "max": 39, "encounter": "Ogrillon" },
    { "min": 40, "max": 41, "encounter": "Orc", "note": "20% are soldiery" },
    { "min": 42, "max": 45, "encounter": "Orc and Ogrillon", "note": "20–80 encountered" },
  ...
  { "min": 15, "max": 16, "encounter": "Goblin and Wargs" },
