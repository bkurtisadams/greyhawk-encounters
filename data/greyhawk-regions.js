...
export const GREYHAWK_REGIONAL_TABLES = {
  ...
  "BanditKingdoms_HornedSociety_Iuz_Rovers": [
    ...
    { min: 3, max: 6, encounter: "Centaurs" },
    { min: 7, max: 8, encounter: "Giants" },
    { min: 9, max: 10, encounter: "Gnolls" },
    { min: 11, max: 12, encounter: "Gnolls and Flinds" },
    { min: 13, max: 15, encounter: "Goblins" },
    { min: 16, max: 17, encounter: "Goblins and Wargs" },
    { min: 18, max: 19, encounter: "Goblins and Xvarts" },
    { min: 20, max: 25, encounter: "Hobgoblins" },
    { min: 26, max: 30, encounter: "Hobgoblins and Workers" },
    { min: 31, max: 32, encounter: "Humanoids (unspecified)" },
    { min: 33, max: 35, encounter: "Kobolds" },
    { min: 36, max: 38, encounter: "Men, Bandits" },
    { min: 39, max: 43, encounter: "Men, Brigands" },
    { min: 44, max: 46, encounter: "Men, Merchants" },
    { min: 47, max: 50, encounter: "Men, Nomads" },
    { min: 51, max: 51, encounter: "Men, Patrol, Knights" },
    { min: 52, max: 53, encounter: "Men, Patrol, Medium" },
    { min: 54, max: 55, encounter: "Men, Raiders" },
    { min: 56, max: 59, encounter: "Men, Tribesmen" },
    { min: 60, max: 61, encounter: "Workers" },
    { min: 62, max: 63, encounter: "Ogres" },
    { min: 64, max: 65, encounter: "Ogrillons" },
    { min: 66, max: 70, encounter: "Orcs" },
    { min: 71, max: 72, encounter: "Orcs and Ogrillons" },
    { min: 73, max: 74, encounter: "Qullans" },
    { min: 75, max: 76, encounter: "Soldiery (e.g. hobgoblin or orc troops)" },
    { min: 77, max: 78, encounter: "Trolls" },
